"""
Stub module for the Programación (Scheduling) feature.
"""
...
class ProgramacionScreen(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.panel.setObjectName("programacionPanel")
        self.panel.setStyleSheet("""
            QFrame#programacionPanel {
                background: #101d2c;
        ...
        title = QLabel("Módulo de Programación")
